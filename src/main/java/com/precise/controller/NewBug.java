	      ...
	      <option value="" selected>Assigned SubModule</option>
		   ...
		   <div class="col-sm-2">
	            <label for="bug discription">Bug Description</label> </div>
	                    <div class="col-sm-4">
		<textarea name="description" placeholder="description" rows="4" cols="49" style="resize:none;"></textarea></div>
		</div>
		   </br>   
	      ...
	      <select class="form-control"  name="round" id="round" >
			...
			<input type="file" name="FileData"  id="id" size="40" onchange="checkFileTypeForPhoto(id)" placeholder="choose file">
              ...
              <div class="col-sm-4">
			 <input type="text" class="form-control" id="depends" name="depends"placeholder="enter dependency">
			</div></div>
			</br>
          <div class="col-sm-3"></div>
             
               <div class="col-sm-3"><button  type="submit"  id="submit" class="btn  btn-block" style="background-color: #006780; color: #fff;">Submit As New Bug</button></div>
			</form> 
    </div></div>
         </div>
