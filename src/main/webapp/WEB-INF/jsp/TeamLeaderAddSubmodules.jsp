			...
			<div class="clearfix">
				<div class="pull-left">
					<ul class="list-inline link-list">
						...
						<li><a href="tlhome">Sub Module</a></li>
					</ul>
				</div>
 ...
 <div class="modal fade" id="addmodal2" role="dialog" >
	...
	<form class="" id="savethemodules" method="post" >
				<div class="border">
					...
					<div class="col-sm-4">
						<select class="form-control" name="projectId" id="projectId" onchange="getallmodules(this);">
...
function deleteStudent(id){
	...
	document.getElementById("deleteSubModuleForm").action = "tldeletesubmodule1";
	...
	<script>
	    ...
	    function saveit(){
			document.getElementById("savethemodules").action = "tlsavesubmodules1";
			document.getElementById("savethemodules").method = "post";
			document.getElementById("savethemodules").submit();
        }
	    
	    function updateit(){
			document.getElementById("updateindividualsubmodulel").action = "tlupdateindividualsubmodule1";
