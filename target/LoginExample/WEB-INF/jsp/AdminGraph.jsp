 ...
 <html>
  ...
  <title>Project Tracking Management</title>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
      var data=[];
      var Header= ['submodname', 'submodule'];
      data.push(Header);

      <c:forEach items="${listrole}" var="list" varStatus="loop">
     var temp=[];
     temp.push("${list.subModuleNameIndividually}");
     temp.push(parseInt('${list.percentage}'));
     data.push(temp);
	</c:forEach>
     var chartdata = new google.visualization.arrayToDataTable(data);
     var options = {
   	      title: 'Completion of SubModules',
   	      legend: { textStyle: { fontSize: '12' } },
   	      hAxis: { title: 'SubModuleName', textStyle: { fontSize: '15', color: '#355404'}, slantedText: true, slantedTextAngle: '45'},
