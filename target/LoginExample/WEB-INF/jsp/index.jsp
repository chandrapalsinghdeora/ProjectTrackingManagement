...
<div class="container" style="padding-top:200px;min-height:738px;">
    <form class="form-signin" action="login" method="post">        
      ...
      <label style="color:red">${invalidmessage}</label>
      
         <div class="form-group">
      <button class="btn btn-lg btn-primary btn-block" type="submit">Login</button> 
      </div>
       <div class="form-group"><a href="registerit">Register here</a>
      </div> 
      <div class="form-group"><a  href="getemail">Forgot password?</a>
      </div>
    </form>
  </div>
