...
$(document).on("click", "#edit", function () {
	...
	function deletemodule(id){
		...
		document.getElementById("deleteModuleForm").action = "deleteModule";
		document.getElementById("deleteModuleForm").method = "post";
		document.getElementById("deleteModuleForm").submit();
	}
	    
		function saveit(){
				document.getElementById("savethemodules").action = "sasavemodules";
				document.getElementById("savethemodules").method = "post";
				document.getElementById("savethemodules").submit();
		}
		
		function updateit(){
			document.getElementById("updateindividualmodulel").action = "updateindividualmodule";
