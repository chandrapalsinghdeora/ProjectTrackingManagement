...
function deleteStudent(id){
	...
	document.getElementById("deleteSubModuleForm").action = "pmdeletesubmodule1";
	...
	<script>
	    ...
	    function saveit(){
			document.getElementById("savethemodules").action = "pmsavesubmodules1";
			document.getElementById("savethemodules").method = "post";
			document.getElementById("savethemodules").submit();
        }
	    
	    function updateit(){
			document.getElementById("updateindividualsubmodulel").action = "pmupdateindividualsubmodule1";
